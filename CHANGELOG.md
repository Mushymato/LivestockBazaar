...
### Added
- Integration with mod name tooltips, you can now see which mod added a farm animal.

### Changed
- Buildings in animal manage menu now uses the full width until you select the second building.
...
### Added
- You can now make pets that talk.

## [1.6.2] - 2026-06-17

### Fixed
- Stack overflow issue with `BazaarContextMain.GetHashCode`

## [1.6.1] - 2026-05-04

### Added
- Option to display a farm animal's internal ID on the shop menu (default off).
- More stardew access screen reads pt2.

### Fixed
- NRE when animal has null deluxe produce
